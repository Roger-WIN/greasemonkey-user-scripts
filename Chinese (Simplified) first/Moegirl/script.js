...
// @license          MIT
// @updateURL        https://github.com/Roger-WIN/greasemonkey-user-scripts/raw/master/Chinese%20(Simplified)%20first/Moegirl/script.js
...
(() => {
    ...
    let flags_exclude = ['.']; // 表示路径中含有文件，因为文件的扩展名以 . 开头
